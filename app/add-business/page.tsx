        ...
        <div className="bg-white rounded-xl shadow-lg p-8 mb-8">
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-6 mb-8">
            ...
            <p className="text-blue-800 text-lg">
              Get featured in the community-powered Filipino food directory across America — completely free.
            </p>
          </div>
          ...
          {/* --- LISTING ELIGIBILITY SECTION --- */}
          <section className="mb-2">
            <div className="border border-gray-200 rounded-xl overflow-hidden">
              {/* Section header */}
              <div className="px-6 py-4" style={{ background: 'linear-gradient(90deg, #62438D, #92345A)' }}>
                <h2 className="text-xl font-bold text-white">Does Your Business Qualify?</h2>
                <p className="text-purple-200 text-sm mt-1">
                  We review every submission to keep the directory accurate and useful.
                </p>
              </div>

              <div className="p-6 bg-white">
                <p className="text-gray-700 text-sm leading-relaxed mb-5">
                  FilipinoFoodNearMe.org lists businesses that serve Filipino food or carry Filipino food products.
                  To be approved, your business should meet at least one of the following:
                </p>
                ...
                <div className="space-y-4 mb-6">
                  <div className="flex gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 text-sm">Filipino dishes make up a meaningful part of what you serve — not just a single occasional item.</p>
                    </div>
                  </div>
                  <div className="flex gap-3">
                    <span className="text-green-600 font-bold text-lg flex-shrink-0">✓</span>
                ...
                <div className="bg-gray-50 border border-gray-200 rounded-lg px-5 py-4 mb-5">
                  <p className="text-sm text-gray-600 leading-relaxed">
                    <strong className="text-gray-800">Note on ownership:</strong> Filipino ownership is not a requirement and is not checked during review.
                    We welcome all businesses — of any background — that serve Filipino food. Listings are food-based, not identity-based.
                  </p>
                </div>

                <p className="text-sm text-gray-500">
                  Read our full{' '}
                  <Link href="/listing-policy" className="text-purple-700 hover:underline font-medium">
                    listing policy →
                  </Link>
                </p>
              </div>
          ...
          {/* --- END LISTING ELIGIBILITY SECTION --- */}
