            ...
            <div className="grid md:grid-cols-3 gap-6">
              {related.map(r => (
                <Link key={r.id} href={'/cultural-knowledge-base/' + r.slug}
                  ...
                  {r.hero_image_url
                    ? <div className="h-36 overflow-hidden"><img src={r.hero_image_url} alt={r.title} className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-300" /></div>
                  ...
                  <div className="p-4">
                    <h3 className="font-bold text-gray-900 group-hover:text-purple-700 transition-colors text-sm mb-1">{r.title}</h3>
