...
const ckb = `import { createClient } from '@supabase/supabase-js'
...
const newsroom = `import { createClient } from '@supabase/supabase-js'
import Link from 'next/link'
import { notFound } from 'next/navigation'
...
console.log('CKB:', fs.statSync('app/cultural-knowledge-base/[slug]/page.tsx').size, 'bytes');
console.log('Newsroom:', fs.statSync('app/newsroom/[slug]/page.tsx').size, 'bytes');
